    ...
    <section className="section-padding">
      <FadeBlur className="page-wrap max-w-xl" immediate>
        ...
        <p className="mt-6 leading-relaxed text-muted">
          Vielen Dank. Die gekauften Lead-Daten werden Ihnen zugestellt. Digitale
          Datenverkäufe sind von der Rückerstattung ausgeschlossen. Details stehen in den AGB.
        </p>
